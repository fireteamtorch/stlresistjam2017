label Day6Block:
    ...
    show text "{size=90}Week 6{/size}" at Transform(xalign = 0.5, yalign = 0.45) as text1
    #show top_text at truecenter
    with Dissolve(2.0)
    show text "{size=70}Picking Up the Pieces{/size}" at Transform(xalign = 0.5, yalign = 0.55) as text2
    with Dissolve(2.0)
    ...
    show braxton sit lookRight at Seat3
    ...
    show braxton smile lookPlayer at Seat3

    braxton "To the left."
    
    bartender "Should a teacher be talking like that?"
    
    show braxton smile lookRight at Seat3
    ...
    show elysia sit lookRight at Seat1 behind bgCounterTop
    show braxton sit lookLeft at Seat3

    "Elysia comes through the door, opening it with slightly more force than usual."
    
    show elysia sit lookLeft at Seat1 
    ...
    show elysia smile lookRight at Seat1
    ...
    show  elysia smile lookPlayer at Seat2

    elysia "I think I'm good. Just a scrape is all."
    
    braxton "What happened?"

    show elysia lookRight at Seat2
    ...
    show elysia smile lookRight at Seat2
