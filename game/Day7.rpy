label Day7Block:
    ...
    frank "Much better... ah, the taste doesn't go away easy."
    ...
    show frank sad no hat at Seat2
    with Dissolve(disFactor)
    ...
    with Dissolve(disFactor)
    show frank smile beer LookRight at Seat2
    with Dissolve(disFactor)
